...
public class BasicBehaviour : MonoBehaviour
{
    ...
    public string crouchButton = "Crouch";                // Default crouch key.
    ...
    private bool crouch;                                  // Boolean to determine whether or not the player is crouching.
